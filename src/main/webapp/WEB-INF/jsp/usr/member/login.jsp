    ...
    <input type="hidden" name="afterLoginUri" value="${param.afterLoginUri}"/>
      <div class="rounded-md shadow-sm -space-y-px">
        <div class="mb-4">
          ...
          <input id="email-address" name="loginId" type="text" autocomplete="email" required class="rounded-full appearance-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="LoginId">
        </div>
        <div>
          <label for="password" class="mb-2">PW</label>
          <input id="password" name="loginPw" type="password" autocomplete="current-password" required class="rounded-full appearance-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Password">
        </div>
      </div> 
